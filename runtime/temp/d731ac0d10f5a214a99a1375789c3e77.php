<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\index\index.html";i:1762686691;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\head.html";i:1764582846;s:73:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\top.html";i:1764932008;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\left.html";i:1764844534;s:75:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\right.html";i:1762686691;}*/ ?>
<!doctype html>
...
<script>
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><?php echo $_SESSION['think']['name']; ?></a>
            <dl class="layui-nav-child">
                <!-- 二级菜单 -->
                <!-- <dd>
                ...
                <dd>
                    <a href="<?php echo url('Login/logout'); ?>">切换帐号</a>
                </dd>
                <dd>
        ...
        <li class="layui-nav-item to-index">
            <a href="<?php echo url('../index'); ?>" target="_blank">前台首页</a>
        </li>
        <li class="layui-nav-item to-index">
            <a href="<?php echo url('Index/clear'); ?>">清除缓存</a>
        </li>
    </ul>
</div>
        <!-- 顶部结束 -->
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('用户列表','memberlist.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite></a>
                    </li>
                    <!-- <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('轮播列表','<?php echo url('Lunbo/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>轮播列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('多级分类','<?php echo url('Colum/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>多级分类</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('文章管理','<?php echo url('Article/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章管理</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('配置列表','<?php echo url('Conf/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>配置列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('配置项列表','<?php echo url('Conf/list'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>配置项列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理员列表','<?php echo url('index/memberlist'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite></a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('权限管理','<?php echo url('AuthGroup/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限管理</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('规则管理','<?php echo url('AuthRule/index'); ?>')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>规则管理</cite></a>
                    </li>
                </ul>
