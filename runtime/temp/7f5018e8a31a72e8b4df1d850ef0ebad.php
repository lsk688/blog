<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\auth_group\index.html";i:1764753624;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\head.html";i:1764582846;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            ...
                            <a href="<?php echo url('add'); ?>" style="margin-left: 10px;"><button class="layui-btn"><i class="layui-icon"></i>添加</button></a>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr">
                                      ...
                                      <td><?php echo !empty($data['status']) && $data['status']==1?'启用':'禁用';; ?></td>
                                      <td class="td-manage">
                                        <a title="编辑" href="<?php echo url('update',array('id'=>$data['id'])); ?>">
                                          <i class="layui-icon">&#xe642;</i>
                                        </a>
                                        &nbsp;&nbsp;|&nbsp;&nbsp;
                                        <a title="删除" href="<?php echo url('del',array('id'=>$data['id'])); ?>">
                                          <i class="layui-icon">&#xe640;</i>
                                        </a>
                                      </td>
                                    </tr>
