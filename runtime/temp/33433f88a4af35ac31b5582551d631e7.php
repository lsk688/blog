<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\index\memberlist.html";i:1765612897;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\head.html";i:1764582846;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="<?php echo url('memberList'); ?>" method="get">
                                ...
                                <tbody>
                                  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
                                    <tr id="tr<?php echo $value['id']; ?>">
                                      <td>
                                        <input type="checkbox" name="id" value="<?php echo $value['id']; ?>" lay-skin="primary"> 
                                      </td>
                                      <td><?php echo $value['id']; ?></td>
                                      <td><?php echo $value['username']; ?></td>
                                      <!-- <td><?php echo !empty($value['lastlogin']) && $value['lastlogin']=='0'?'从未登录':$value['lastlogin'];; ?></td> -->
                                      <td>
                                        <!-- <?php if($value['lastlogin'] == 0): ?>
                                          从未登录
                                        <?php else: ?>
                                          <?php echo $value['lastlogin']; endif; ?> -->
                                      <?php echo !empty($value['lastlogin']) && $value['lastlogin']=='Null'?'从未登录':$value['lastlogin'];; ?>
                                      </td>
                                      ...
                                      <td class="td-manage">
                                        <?php if($value['status'] == 1): ?>
                                          <a onclick="member_stop(this,<?php echo $value['id']; ?>,<?php echo $value['status']; ?>)" href="javascript:;"  title="启用">
                                            <i class="layui-icon">&#xe601;</i>
                                          </a>
                                        <?php else: ?>
                                          <a onclick="member_stop(this,<?php echo $value['id']; ?>,<?php echo $value['status']; ?>)" href="javascript:;"  title="停用">
                                            <i class="layui-icon">&#xe62f;</i>
                                          </a>
                                        <?php endif; ?>
                                        <a title="编辑"  onclick="xadmin.open('编辑','<?php echo url('memberedit',array('id'=>$value['id'])); ?>',600,400)" href="javascript:;">
                                          <i class="layui-icon">&#xe642;</i>
                                        </a>
                                        <a onclick="xadmin.open('修改密码','<?php echo url('memberpassword',array('id'=>$value['id'])); ?>',600,400)" title="修改密码" href="javascript:;">
                                          <i class="layui-icon">&#xe631;</i>
                                        </a>
