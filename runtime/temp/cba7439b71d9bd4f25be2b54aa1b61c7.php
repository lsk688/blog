<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\auth_group\update.html";i:1764757927;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\head.html";i:1764582846;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="layui-card-body layui-table-body layui-table-main">
                            <form class="layui-form" action="" method="POST">
							    ...
							    <div class="layui-input-block">
							      <select name="title" lay-verify="required">
							      	<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
							      		<option value="<?php echo $data['id']; ?>" <?php echo !empty($AuthGroup['title']) && $AuthGroup['title']==$data['id']?'selected':'';; ?>><?php echo $data['username']; ?></option>
							  ...
							  <div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							      <input type="radio" name="status" value="1" title="开启" <?php echo !empty($AuthGroup['status']) && $AuthGroup['status']==1?'checked':''; ?>>
							      <input type="radio" name="status" value="0" title="禁用" <?php if(empty($AuthGroup['status'])) echo 'checked'; ?>>
							    </div>
							  </div>
							  <div class="layui-form-item">
							    <div class="layui-input-block">
							      ...
							      <a href="<?php echo url('index'); ?>" class="layui-btn layui-btn-primary">取消修改</a>
							    </div>
							  </div>
							</form>
                        </div>
