<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\conf\update.html";i:1764922796;s:74:"D:\phpstudy_pro\WWW\blog\public/../application/admin\view\public\head.html";i:1764582846;}*/ ?>
<!DOCTYPE html>
                            ...
                            <form class="layui-form" action="" method="POST">
							  <div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							      <input type="text" name="cname" value="<?php echo $data['cname']; ?>" required  lay-verify="required" placeholder="请输入配置中文" autocomplete="off" class="layui-input">
							    </div>
							  </div>
							  <div class="layui-form-item">
							    <label class="layui-form-label">配置英文</label>
							    <div class="layui-input-block">
							      <input type="text" name="ename" value="<?php echo $data['ename']; ?>" required  lay-verify="required" placeholder="请输入配置英文" autocomplete="off" class="layui-input">
							    </div>
							  </div>
							   <div class="layui-form-item">
							    ...
							    <div class="layui-input-block">
							      <select name="type" lay-verify="required">
							        ...
							        <option value="1" <?php echo !empty($data['type']) && $data['type']==1?'selected':'';; ?>>单行文本</option>
							        <option value="2" <?php echo !empty($data['type']) && $data['type']==2?'selected':'';; ?>>多行文本</option>
							        <option value="3" <?php echo !empty($data['type']) && $data['type']==3?'selected':'';; ?>>单选按钮</option>
							        <option value="4" <?php echo !empty($data['type']) && $data['type']==4?'selected':'';; ?>>多选按钮</option>
							        <option value="5" <?php echo !empty($data['type']) && $data['type']==5?'selected':'';; ?>>下拉菜单</option>
							      </select>
							    </div>
							  </div>
							  <div class="layui-form-item layui-form-text">
							    ...
							    <div class="layui-input-block">
							      <textarea name="vals" placeholder="请输入可选值" class="layui-textarea"><?php echo $data['vals']; ?></textarea>
							    </div>
							    <div class="layui-input-block">
